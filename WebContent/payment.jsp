				...
				<div class="col-12">
					<div class="page__content">
						<div class="nav page__nav" role="tablist">
							<a class="active" id="tab-1" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true">Credit card</a>

							<a class="" id="tab-2" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">Bank card to the courier</a>

							<a class="" id="tab-3" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false">Cash on delivery</a>
						</div>
						...
						<div class="tab-content">
								...
								<div class="page__double">
									<div class="page__double-title">
										...
										<div class="page__cards">
											<span><i class="pf pf-visa"></i></span>
											<span><i class="pf pf-mastercard"></i></span>
											<span><i class="pf pf-maestro"></i></span>
										</div>
									</div>
							...
							<div id="tab2" class="tab-pane fade" role="tabpanel" aria-labelledby="tab-2">
								<div class="page__double">
									<div class="page__double-title">
										<h3>Bank card to the courier</h3>
