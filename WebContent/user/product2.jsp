			...
			<div class="row">
				...
				<div class="col-12 col-md-6">
					<div class="product-head__content product-head__content--2">
						<h1 class="product-head__title product-head__title--dark">Toaster t298</h1>
						<p class="product-head__text product-head__text--dark">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, orrandomised words which don't look even slightly believable.</p>
						...
						<div class="product-head__list">
							...
							<div class="product-head__colors">
						...
						<div class="product-head__list">
							<button class="product-head__btn product-head__btn--dark" type="button">buy</button>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-12 col-md-6 order-md-2">
					<img src="../img/product/img.jpg" alt="" class="land__img land__img--right">
				</div>

				<div class="col-12 col-md-6 order-md-1">
					<h2 class="land__title land__title--left">Control of cooking time</h2>
			...
			<div class="row align-items-center">
				<div class="col-12 col-md-6">
					<img src="../img/product/img2.jpg" alt="" class="land__img">
				</div>

				<div class="col-12 col-md-6">
					<h2 class="land__title land__title--right">Intuitive controls</h2>
