				...
				<div class="col-12">
					<div class="account">
						<div class="nav page__nav page__nav--white" role="tablist">
							<a class="active" id="tab-1" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true">工作</a>

							<a class="" id="tab-2" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">个人信息</a>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<form action="#" class="account__form account__form--last">
											<div class="row">
												<div class="col-12">
													<h3 class="cart__form-title">Password change</h3>
												</div>
												...
												<div class="col-12">
													<button class="form__send" type="button">Change</button>
												</div>
											</div>
										</form>
									</div>
